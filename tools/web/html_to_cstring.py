...
USAGE
-----
  python3 tools/web/html_to_cstring.py NetHID.html                 # -> stdout
  python3 tools/web/html_to_cstring.py NetHID.html -n MAIN_HTML    # name the var
  python3 tools/web/html_to_cstring.py NetHID.html -o main.txt     # to a file
