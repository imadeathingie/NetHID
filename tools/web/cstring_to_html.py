...
USAGE
-----
  python3 tools/web/cstring_to_html.py src/web.cpp                  # MAIN_HTML -> stdout
  python3 tools/web/cstring_to_html.py src/web.cpp -n LOGIN_HTML
  python3 tools/web/cstring_to_html.py src/web.cpp -o NetHID.html
"""
